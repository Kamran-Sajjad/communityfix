...
// // export default Sidebar;
// import { useState } from "react";
// import { Users, MessageSquare, CircleDashed, LogOut, Menu, Home } from "lucide-react";
// import { Link } from "react-router-dom";
// import logo from "../../assets/logo.png";
...
//                 text="Dashboard"
//                 to="/serviceTeam/MechanicDashboard"
//               />
//               <NavLink
//                 icon={<Users className="w-6 h-6" />}
//                 text="Assigned Issues"
//                 to="/serviceTeam/AssignedIssuesPage"
//               />
//               <NavLink
//                 icon={<MessageSquare className="w-6 h-6" />}
//                 text="Reviews"
//                 to="/serviceTeam/ReviewsPage"
//               />
//               <NavLink
//                 icon={<CircleDashed className="w-6 h-6" />}
//                 text="Reports"
//                 to="/serviceTeam/ReportsPage"
//               />
//               {/* ✅ New Link for Household Reports Page */}
//               <NavLink
//                 icon={<Home className="w-6 h-6" />}
//                 text="Household Reports"
...
//     <Link
//       to={to}
//       className={`flex items-center space-x-3 text-white hover:text-gray-300 transition-colors ${className}`}
//     >
//       {icon}
//       <span className="text-lg font-medium">{text}</span>
//     </Link>
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        {/* Container ensures scroll and bottom-logout */}
        <div className="flex flex-col h-full overflow-hidden">
          {/* Top part (logo + links) is scrollable */}
          <div className="overflow-y-auto flex-grow">
            ...
            <div className="flex flex-col space-y-6 px-6 py-8">
              ...
              <NavLink icon={<MessageSquare className="w-6 h-6" />} text="Reviews" to="/serviceTeam/ReviewsPage" />
              <NavLink icon={<CircleDashed className="w-6 h-6" />} text="Reports" to="/serviceTeam/ReportsPage" />
              <NavLink icon={<Home className="w-6 h-6" />} text="Household Reports" to="/household-reports" />
            </div>
          </div>

          {/* Bottom part — logout stays visible */}
