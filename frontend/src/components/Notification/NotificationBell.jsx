...
import api from "../../utils/api";
import { useAuth } from "../../context/AuthContext";
import { connectSocket, getSocket } from "../../utils/socket"; // ✅ socket integration
...
const NotificationBell = ({ color = "white" }) => {
  ...
  useEffect(() => {
  const suspended = notifications.find(
    n => n.notificationType === "user_suspended" && !n.isRead
  );
  if (suspended) {
  ...
  useEffect(() => {
    ...
    const handleNewNotification = (data) => {
      toast.info(data.message); // show real-time toast
