...
//       <div className="flex items-center justify-between">
//         <div>
//           <h3 className="text-lg font-medium">Work Progress</h3>
//           <div className="flex items-center gap-4 mt-4">
//             <div className="relative h-16 w-16">
//               <svg
//                 className="h-full w-full"
...
export const WorkProgress = () => {
  ...
  return (
    <div className="bg-black text-white p-6 rounded-lg shadow-lg shadow-purple-200 w-full max-w-sm mx-auto h-auto">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-medium">Work Progress</h3>
          <div className="flex items-center gap-4 mt-4">
